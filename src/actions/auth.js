import { LOGIN_REQUEST, LOGIN_SUCCESS, LOGIN_FAILURE, LOGOUT_SUCCESS, LOGOUT_REQUEST } from "./../constants/actionTypes";
    ...
    cFetch(API_CONFIG.auth, { method: "POST", body: JSON.stringify(creds) })
      .then((response) => {
        if (response.jsonResult.error_code === 4001) {
          ...
          cookie.set(AUTH_ACCESS_TOKEN, response.jsonResult.access_token);
